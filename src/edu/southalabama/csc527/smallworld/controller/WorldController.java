...
public final class WorldController {
	...
	public void travel(Direction direction) {
		...
		if (playerLocation.isTravelAllowedToward(direction)) {
			...
			if(newPlayerLocation.getMonster() != null && newPlayerLocation.getMonster().stillAlive()){
	 ...
	 * @param fight the instance of combat
	 */
	...
	/**
	 * Escapes the current fight
	 * @param fight the instance of combat
	 * @return the direction of retreat
	 */
	public Direction run(Fight fight){
		
		System.out.println("Run was called.");
		fight.fightTransition();
	 	if(!f_world.getPlayer().getLocation().getMonster().getGuarding().contains(Direction.NORTH)){
    		return Direction.NORTH;
    	}
    	else if(!f_world.getPlayer().getLocation().getMonster().getGuarding().contains(Direction.SOUTH)){
    		return Direction.SOUTH;
    	}
    	else if(!f_world.getPlayer().getLocation().getMonster().getGuarding().contains(Direction.EAST)){
